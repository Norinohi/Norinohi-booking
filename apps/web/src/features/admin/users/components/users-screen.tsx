...
/* UsersScreen — /users: the admin Sidebar beside every account, in the Bookings screen's shell. */

export default function UsersScreen({ user }: { user: { name: string; email: string } }) {
