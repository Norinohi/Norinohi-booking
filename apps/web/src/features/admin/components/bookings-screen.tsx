...
/*
 * BookingsScreen — /staff/bookings: the admin Sidebar beside every booking on the platform,
 * in the same shell as the Audit and Sync History screens.
 *
 * The row actions live on the detail screen this list links into rather than here. Cancelling
 * and refunding both move real money, and a per-row button on a paged list is one mis-click
 * away from doing it to the wrong booking.
 */
