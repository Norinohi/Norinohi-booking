      ...
      <TooltipTrigger
        render={
          <button
            ...
            className={cn(
              "min-w-0 cursor-pointer items-start gap-1 text-left text-xs font-semibold leading-[1.3] text-brand underline decoration-dotted outline-none focus-visible:ring-2 focus-visible:ring-ring/40",
              className,
            )}
          />
        }
