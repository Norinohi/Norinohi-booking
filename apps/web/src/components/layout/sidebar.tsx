 ...
 * (brand-50 + brand text) and a destructive "Log Out". Admin adds "Inbox", "Discount Manager",
 * "Duplicate Review" and "Sync History".
...
const ADMIN_ITEMS = ["inbox", "discount", "duplicates", "sync"] as const;
