  ...
  return (
    <button
      ...
      className={cn(
        ...
        "flex w-103.5 max-w-full cursor-pointer flex-col gap-1.5 rounded-lg p-5 text-left ring-inset outline-none transition-[background-color,box-shadow] focus-visible:ring-2 focus-visible:ring-ring/40",
        selected
