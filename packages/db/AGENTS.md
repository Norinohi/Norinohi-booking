...
pnpm db:generate  # creates src/migrations/ (does not exist yet)
```
...
- `drizzle.config.ts` sets `out: "./src/migrations"`, so generated SQL lands inside `src/`. Never hand-edit files there once generated.
