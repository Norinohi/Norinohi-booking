 ...
 * under the same world region, and a shipyard NauSYS names "Unknown". Two boats per combination
...
describe("listCatalogPages withholds pages that name no place or no shipyard", () => {
  ...
  it("keeps a sailing region and drops a world region shared across countries", async () => {
