...
ALTER TABLE "price_adjustment_snapshot" ADD COLUMN "currency" text;--> statement-breakpoint
UPDATE "price_adjustment_snapshot" AS s SET "currency" = q."currency" FROM "quote" AS q WHERE q."id" = s."quote_id";--> statement-breakpoint
ALTER TABLE "price_adjustment_snapshot" ALTER COLUMN "currency" SET NOT NULL;